...
function Signup() {
    ...
    const validate = () => {
        ...
        if (!password || password.length <= 3) newErrors.password = 'Password must be greater than 3 characters';
            ...
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form className="w-full max-w-md" onSubmit={handleSubmit}>
                    ...
                    {error.confirmPassword && (
                        <span className="text-red-500 text-sm">{error.confirmPassword}</span>
                    )}
                    {/* Submit Button */}
                    <div className="mt-6">
                        <button
